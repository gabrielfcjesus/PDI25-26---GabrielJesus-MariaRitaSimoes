...
class Command(BaseCommand):
    ...
    def _reset_data(self):
        ...
        from apps.armazem.models import Material, Categoria, MovimentoStock
    ...
    def _criar_departamentos(self):
        from apps.core.models import Departamento, Cargo
    ...
    def _criar_utilizadores(self, departamentos):
        ...
        utilizadores = [
            ...
            },
            {
                ...
                'first_name': 'Ana',
                'last_name': 'Silva',
                'email': 'ana.silva@primetool.pt',
                'departamento': 'rh',
                'cargo': 'Responsável de RH',
            },
            {
                'username': 'carlos.armazem',
                'password': 'teste123',
                'first_name': 'Carlos',
                'last_name': 'Ferreira',
                'email': 'carlos.ferreira@primetool.pt',
                'departamento': 'armazem',
                'cargo': 'Responsável de Armazém',
            },
            {
                ...
                'first_name': 'João',
                'last_name': 'Costa',
                'email': 'joao.costa@primetool.pt',
                'departamento': 'armazem',
                'cargo': 'Operador de Armazém',
            },
            {
                'username': 'pedro.planeamento',
                'password': 'teste123',
                'first_name': 'Pedro',
                'last_name': 'Rodrigues',
                'email': 'pedro.rodrigues@primetool.pt',
                'departamento': 'planeamento',
                'cargo': 'Responsável de Planeamento',
            },
            {
                'username': 'maria.producao',
                'password': 'teste123',
                'first_name': 'Maria',
                'last_name': 'Santos',
                'email': 'maria.santos@primetool.pt',
                'departamento': 'producao',
                'cargo': 'Chefe de Produção',
            },
            {
                'username': 'rui.producao',
                'password': 'teste123',
                'first_name': 'Rui',
                'last_name': 'Oliveira',
                'email': 'rui.oliveira@primetool.pt',
                'departamento': 'producao',
                'cargo': 'Operador de Produção',
            },
            {
                'username': 'sofia.qualidade',
                'password': 'teste123',
                'first_name': 'Sofia',
                'last_name': 'Martins',
                'email': 'sofia.martins@primetool.pt',
                'departamento': 'qualidade',
                'cargo': 'Responsável de Qualidade',
            },
            {
                'username': 'tiago.expedicao',
                'password': 'teste123',
                'first_name': 'Tiago',
                'last_name': 'Pereira',
                'email': 'tiago.pereira@primetool.pt',
                'departamento': 'expedicao',
                'cargo': 'Responsável de Expedição',
            },
            {
                'username': 'bruno.montagem',
                'password': 'teste123',
                'first_name': 'Bruno',
                'last_name': 'Alves',
                'email': 'bruno.alves@primetool.pt',
                'departamento': 'montagem',
                'cargo': 'Chefe de Montagem',
            },
        ]
